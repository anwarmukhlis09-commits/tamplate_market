...
const finalPrice = computed(
    () => props.template.discountPrice || props.template.price,
);
    ...
    >
        ...
        <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <p class="text-slate-500 mb-8">
                Selesaikan pembelian template pilihan Anda
            </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6">
                ...
                <div class="space-y-5">
                    ...
                    >
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="w-16 h-16 rounded-xl bg-gradient-to-br flex items-center justify-center text-white shrink-0"
                                :class="
                                    template.imageUrl
                                        ? ''
                    ...
                    >
                        ...
                        <div
                            class="flex items-start gap-3 p-4 bg-indigo-50 border border-indigo-200 rounded-xl"
                        >
                            <div
                                class="w-10 h-10 rounded-lg bg-white flex items-center justify-center shrink-0 border border-indigo-100"
                            >
                                <svg
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <span
                                        class="text-[10px] font-bold uppercase tracking-wider text-indigo-600 bg-indigo-100 px-1.5 py-0.5 rounded"
                                        >Aman</span
                                    >
                                </div>
                                <p
                                ...
                                >
                                    Pembayaran diproses via Tripay. Anda bisa
                                    pilih metode favorit di langkah berikutnya:
                                    <span class="font-semibold text-slate-700"
                                        >BCA VA, QRIS, DANA, Alfamart, Alfamidi,
                                        Indomaret, Mandiri VA</span
                                    >, dan lainnya.
                                </p>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            class="mt-5 w-full py-3.5 text-sm font-bold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 shadow-md disabled:opacity-50 transition-colors"
                        >
                ...
                <!-- RIGHT: Summary -->
                <aside
                    class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm h-fit lg:sticky lg:top-24"
                >
                    <h2 class="text-sm font-bold text-slate-900 mb-3">
                        Ringkasan
                    </h2>
                    <dl class="space-y-2 text-sm">
                        ...
                        <div
                            class="pt-3 border-t border-slate-200 flex justify-between"
                        >
                            <dt class="font-bold text-slate-900">Total</dt>
                            <dd class="font-extrabold text-indigo-600 text-lg">
                                {{ formatPrice(total) }}
                            </dd>
                        </div>
                    </dl>
                    ...
                    <div
                        class="mt-5 pt-5 border-t border-slate-100 text-xs text-slate-500 space-y-1.5"
                    >
