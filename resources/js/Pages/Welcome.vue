...
<template>
    <Head
        title="Template Hotspot — Marketplace Template Hotspot MikroTik Terbaik & Siap Pakai"
    />
    ...
    <MarketplaceLayout>
        ...
        >
            <!-- ═══════════════ HERO SECTION ═══════════════ -->
            <section
                class="relative pt-20 pb-16 sm:pt-24 sm:pb-20 overflow-hidden"
            >
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        >
                            ...
                            <div
                                class="w-8 h-8 rounded-full flex items-center justify-center bg-gradient-to-br text-white shadow-sm transition-transform duration-300 group-hover:scale-110"
                            ...
                            <span class="flex items-center gap-1.5">
                                {{ cat.name }}
                                <span
                                    class="text-xs text-slate-400 group-hover:text-indigo-500 font-medium"
                                    >({{ cat.count }})</span
                                >
                            </span>
                        </Link>
