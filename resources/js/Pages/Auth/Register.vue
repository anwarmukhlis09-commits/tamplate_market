...
<template>
<Head title="Daftar — Template Hotspot" />
    ...
    <div class="w-full max-w-6xl bg-white/95 backdrop-blur-xl rounded-[32px] shadow-2xl p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="flex flex-col justify-center px-8 py-12 md:px-20">
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl font-bold text-slate-900 mb-3">Buat Akun Baru</h1>
                <p class="text-sm text-slate-500">Daftar untuk mulai menjual template hotspot Anda</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button
                            ...
                            class="absolute inset-y-0 right-0 z-10 flex items-center justify-center w-12 text-slate-400 hover:text-indigo-600 transition-colors rounded-r-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                        >
                            <svg v-if="!showConfirmPassword" class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <p class="mt-8 text-center text-sm text-slate-500">
                Sudah punya akun?
                <Link :href="route('login')" class="inline-block font-semibold text-indigo-600 hover:text-indigo-800 underline underline-offset-2 cursor-pointer select-none py-1">Masuk di sini</Link>
            </p>
        </div>
        ...
        <div class="hidden md:block relative rounded-[26px] overflow-hidden min-h-[600px] bg-cover bg-center" style="background-image: url('/images/register-illustration.jpg');">
            ...
            <div class="absolute bottom-10 left-10 right-10 text-white">
                <p class="text-3xl font-bold leading-tight">Mulai Jual Template Hotspot Anda</p>
                <p class="text-sm opacity-90 mt-3">Upload template, atur harga, dan dapatkan pelanggan untuk MikroTik, Hotel, Cafe, ISP dan Voucher WiFi.</p>
            </div>
        </div>
