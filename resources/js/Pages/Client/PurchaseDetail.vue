...
>>>>>>> 49a6ab95debc2a31219ec64b920f3a07a53cdc9a
            ...
            >
                <h2 class="text-sm font-bold text-slate-900 mb-4">Template</h2>
                <div
                    class="flex items-center gap-4 pb-5 border-b border-slate-100"
                >
                    <div
                        class="w-20 h-20 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white shrink-0"
                    >
                        <svg
                            class="w-9 h-9"
                            fill="none"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-5">
                    <a
                        :href="`/template/${template.id}/download?source=master`"
                        class="flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors"
                    >
                        <svg
                            class="w-4 h-4"
                            fill="none"
                    ...
                    <Link
                        ...
                        class="flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors"
                    >
                        Lihat Detail
                    </Link>
                    <Link
                        v-if="true"
                        :href="`/template/${template.id}/editor`"
                        class="flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors"
                    >
                        Editor
                    </Link>
